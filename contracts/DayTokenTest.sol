...
uint8 public decimals; 
    ...
    function setInitialMintingPowerOf(uint256 _id) internal onlyContributor(_id) {
     ...
     /**
        ...
        */
    function getMintingPowerByAddress(address _adr, uint day) public constant returns (uint256 mintingPower) {
        return contributors[idOf[_adr]].mintingPower/(2**(getPhaseCount(day))); 
    }
    ...
    /**
        ...
        */
    function getMintingPowerById(uint _id, uint day) public constant returns (uint256 mintingPower) {
        return contributors[_id].mintingPower/(2**(getPhaseCount(day))); 
    }
    ...
    */
    ...
    /**
        ...
        */
    function balanceOf(address _adr, uint day) public constant returns (uint256 balance) {
        uint id = idOf[_adr]; 
        
            if (id <= latestContributerId) {
                require(updateBalanceOf(id, day));
            }
