 ...
 *
 */
contract AddressCappedCrowdsaleTest is CrowdsaleTest {
    ...
    */
    function AddressCappedCrowdsaleTest(address _token, PricingStrategy _pricingStrategy, address _multisigWallet, uint _start, uint _end, uint _minimumFundingGoal, uint _weiIcoCap, uint _preMinWei, uint _preMaxWei, uint _maxWei, uint _maxPreAddresses, uint _maxIcoAddresses) CrowdsaleTest(_token, _pricingStrategy, _multisigWallet, _start, _end, _minimumFundingGoal, _preMinWei, _preMaxWei, _maxWei,  _maxPreAddresses) {
